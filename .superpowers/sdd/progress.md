...
- [x] Task 7: Delete the old `figures.py` module and its tests
- [x] Task 8: Update TUI to drop the vision menu entry
- [x] Task 9: Update `cli.py` (`config_show`) and run final verification
- [x] Task 10: Update README and run end-to-end smoke test
...
Task 7: complete (commits bb51132..73472ea, review clean)
Task 8: complete (handled by Task 7 implementer)
Task 9: complete (handled by Task 7 implementer)
Task 10: complete (commits 73472ea..0712742, manual execution)
